...
class InferenceEngine{
	private:
		typedef string (InferenceEngine::*InEnMFP)(string);
	...
	public:
		...
		string processLine(stringstream & p_ss); // processes instructions on line
		string processFact(string p_string); // processes and adds facts to KB
		string processRule(string p_string); // processes and adds facts to KB
		string processLoad(string p_string); // imports a .sri file
		string processDump(string p_string); // exports a .sri file
		...
		string processInference(string p_string); // processes and executes an Inference
		string processDrop(string p_string); // perform a drop
